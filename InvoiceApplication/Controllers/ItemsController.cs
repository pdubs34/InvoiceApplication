...
namespace InvoiceApplication.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(InvoiceApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Item != null ? 
                          ...
                          Problem("Entity set 'InvoiceApplicationContext.Item'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InvoiceApplicationContext.Item'  is null.");
            }
            var item = await _context.Item.FindAsync(id);
            if (item != null)
            {
